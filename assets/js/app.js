...
<a class="navbar-brand" href="index.html"> Cosmin Rusu </a>
...
<div class="collapse navbar-collapse " id="navbarSupportedContent">
  <ul class="navbar-nav ml-auto" id = "navbar-content">
   ...
   <li class="nav-item nav-item-hover"><a class="nav-link" href="assets/images/CV.pdf">CV</a></li>
   <li class="nav-item">
...
let footer = $(`
    ...
    <a class="social-button twitter" href="https://twitter.com/cosmin016_x" target="_blank">
    ...
    <a class="social-button linkedin" href="https://www.linkedin.com/in/cosmin-rusu-667207183/" target="_blank" >
...
$(document).ready(function () {
  $(window).scroll(function () {
    // El botón estará oculto hasta que nos desplacemos más que la altura de la ventana.
    if ($(window).scrollTop() < $(window).height()) {
      $("#btnScrollToTop").css("visibility", "hidden");
    } else {
      $("#btnScrollToTop").css("visibility", "visible");
      // El botón cambiará de color cuando toque el pie de página.
      if (
        $(window).scrollTop() + $(window).height() >
        $(document).height() - 838
      ) {
        // 838 debe cambiarse si se cambia la altura del pie de página para que el botón cambie su color exactamente cuando golpea el pie de página (preferiblemente 14 menos que la altura de la computadora del pie de página)
...
// Funcion para alternar la clase de menu hamburguesa
...
// Funcion para el subrayado de las palabras de nav bar
...
if (localStorage.getItem("lightMode") == "dark") {
  ...
  // Para poner un tema oscuro mientras carga todo
...
// Funcion para quitar la barra de la nav bar mientras carga
